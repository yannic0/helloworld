...
<html>
    ...
    <body>
        <div class="container">
            <form action="/EmployeeWebAppEditable/employee" method="post"  role="form" data-toggle="validator" >
                ...
                <div class="form-group col-xs-4">
                    ...
                    <label for="empRole" class="control-label col-xs-4">Role:</label>                    
                    <input type="text" name="empRole" id="empRole" class="form-control" value="${employee.empRole}" required="true"/> 
